...
```
DEPLOY_ENV=prod
DEPLOY_HOST=ploneconf2023.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    ploneconf2023.example.com:
      ansible_user: root
      host: ploneconf2023
      hostname: ploneconf2023.example.com
```
...
Deploy the stack defined in `devops/stacks/ploneconf2023.example.com.yml` to the remote server with:
