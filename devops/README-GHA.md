...
2. Go to your repository at [edsonjesus/ploneconf2023](https://github.com/edsonjesus/ploneconf2023).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `ploneconf2023.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | ploneconf2023.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | ploneconf2023.example.com |
...
- [Backend Tests Workflow](https://github.com/edsonjesus/ploneconf2023/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/edsonjesus/ploneconf2023/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/edsonjesus/ploneconf2023-backend`) and Frontend (`ghcr.io/edsonjesus/ploneconf2023-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of ploneconf2023.example.com](https://github.com/edsonjesus/ploneconf2023/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/ploneconf2023.example.com.yml` stack.
